...
<div className="overflow-hidden">
  <img className="my-4 inline-block rounded-md shadow-xs" src="/docs/eternalcore/homes/home-limit-reached.gif" alt="Home limit reached" />
  <div className="bg-muted p-2 text-center text-sm font-medium">Home limit reached message</div>
</div>

<div className="overflow-hidden">
  <img className="my-4 inline-block rounded-md shadow-xs" src="/docs/eternalcore/homes/delhome.gif" alt="Deleting home" />
  <div className="bg-muted p-2 text-center text-sm font-medium">Deleting a home with `/delhome`</div>
</div>
