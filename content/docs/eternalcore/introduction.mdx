...
<AlertBox type="warning" title="📚 EternalCore Docs Are Leveling Up!">
  We're rewriting the documentation with **EternalCore 2.0** — and that includes the docs.
  This is just the first draft of something much bigger.
  👉 Track progress and pitch in: https://github.com/EternalCodeTeam/EternalCore/issues/952
