...
<Steps>
  ...
  <Step title="Check if PacketEvents plugin is enabled" icon="Package">
  ...
  <Step title="Check for console errors" icon="AlertCircle">
...
<Callout type="danger" title="Corrupted Download">
  If you see `java.util.zip.ZipException`, the JAR file may be corrupted. Re-download from the [official source](https://modrinth.com/plugin/eternalcombat).
</Callout>
