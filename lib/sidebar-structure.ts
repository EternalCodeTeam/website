    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: "AdminChat", path: "/docs/eternalcore/features/adminchat", icon: "MessagesSquare",
          },
          ...
          {
            title: "Clear inventory", path: "/docs/eternalcore/features/clear", icon: "BrushCleaning",
          },
          ...
          { title: "Powertools", path: "/docs/eternalcore/features/powertool", icon: "WandSparkles" },
          { title: "Private messages", path: "/docs/eternalcore/features/msg", icon: "MessageSquareLock" },
          { title: "Random teleport", path: "/docs/eternalcore/features/randomtp", icon: "MapPinned" },
          ...
          { title: "Teleport ask-here", path: "/docs/eternalcore/features/tpahere", icon: "MapPinHouse" },
