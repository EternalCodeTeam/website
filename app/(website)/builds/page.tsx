...
import {
  ...
  PROJECTS,
  type Project,
} from "@/app/(website)/api/builds/builds";
...
function BuildExplorerContent() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 text-gray-900 selection:bg-blue-500/30 dark:bg-gray-950 dark:text-white">
      {/* Background Decor */}
