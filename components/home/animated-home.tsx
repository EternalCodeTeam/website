  ...
  return (
    <motion.div className="relative bg-gray-50 dark:bg-gray-950" id="main-content" tabIndex={-1}>
      <div className="pointer-events-none absolute inset-0 z-0 select-none overflow-hidden">
        <div className="absolute top-0 -left-[10%] h-[300px] w-[300px] rounded-full bg-blue-500/10 blur-3xl filter md:h-[600px] md:w-[600px] dark:bg-blue-500/5" />
        ...
        <div className="absolute bottom-[-10%] left-1/2 h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-blue-500/10 blur-3xl filter md:h-[600px] md:w-[600px] dark:bg-blue-500/5" />
