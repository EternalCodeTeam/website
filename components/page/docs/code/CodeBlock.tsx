...
const CodeBlock = memo(({ children, language, ...props }: CodeBlockProps) => (
  <pre
    className="pre prose relative my-4 overflow-x-auto rounded-lg border border-neutral-700 bg-lightGray-200 bg-gray-900 p-4 font-mono text-sm text-neutral-200"
    role="code"
