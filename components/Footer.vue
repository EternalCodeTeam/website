  ...
  <footer class="p-4 sm:p-6 isolate">
    <div class="mx-auto max-w-screen-xl">
      ...
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div v-for="section in sections" :key="section.title">
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{{ section.title }}</h2>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-present EternalCodeTeam. All Rights Reserved.
            </span>
