...
export function NetlifyHighlight() {
  return (
    <a
      ...
      target="_blank"
    >
      <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-gray-50/50 transition-[border-color,box-shadow,background-color] duration-300 hover:border-[#05BDBA]/40 hover:shadow-md dark:border-gray-800 dark:bg-gray-900/20 dark:hover:border-[#32E6E2]/40">
