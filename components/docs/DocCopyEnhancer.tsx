...
const BUTTON_BASE_CLASSES = "absolute z-10 flex items-center gap-1 rounded-md bg-[#23272e] text-gray-300 border border-gray-700 px-3 py-1 text-xs font-medium opacity-70 hover:opacity-100 hover:bg-[#181c23] hover:text-white transition-all shadow pointer-events-auto";
...
export default function DocCopyEnhancer() {
  ...
  const addCopyButton = useCallback((preEl: HTMLElement) => {
