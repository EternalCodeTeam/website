  ...
  return (
    ...
    >
      {prev ? (
        ...
        >
          <div className="flex items-center gap-2 text-sm text-gray-500 transition-colors group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300">
            <ArrowLeft className="h-4 w-4" />
            <span>Previous</span>
          </div>
          <span className="line-clamp-2 text-base font-semibold text-gray-900 transition-colors group-hover:text-blue-600 dark:text-gray-100 dark:group-hover:text-blue-400">
            {prev.title}
          </span>
        </Link>
      ) : (
