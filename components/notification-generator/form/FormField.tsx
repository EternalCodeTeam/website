...
import { Bold, Italic, Underline, Strikethrough, Link, Terminal, MessageSquare, Eye, Palette, Trash2, Plus } from "lucide-react";
      ...
      <div className="flex space-x-1 mb-1">
        {showEditorButtons && (
          <>
            ...
            <Button type="button" variant="outline" size="sm" onClick={() => insertTag("<b></b>")} title="Bold"><Bold className="h-4 w-4" /></Button>
            <Button type="button" variant="outline" size="sm" onClick={() => insertTag("<i></i>")} title="Italic"><Italic className="h-4 w-4" /></Button>
            <Button type="button" variant="outline" size="sm" onClick={() => insertTag("<u></u>")} title="Underline"><Underline className="h-4 w-4" /></Button>
            <Button type="button" variant="outline" size="sm" onClick={() => insertTag("<st></st>")} title="Strikethrough"><Strikethrough className="h-4 w-4" /></Button>
